 ...
 */
final class Version20250108124723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, date_command DATETIME NOT NULL, statut_com VARCHAR(255) NOT NULL, INDEX IDX_8ECAEAD479F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reply (id INT AUTO_INCREMENT NOT NULL, id_admin_id INT NOT NULL, id_comment_id INT NOT NULL, response LONGTEXT NOT NULL, reply_at DATETIME NOT NULL, INDEX IDX_FDA8C6E034F06E85 (id_admin_id), INDEX IDX_FDA8C6E05DE3FDC4 (id_comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reply ADD CONSTRAINT FK_FDA8C6E034F06E85 FOREIGN KEY (id_admin_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE reply ADD CONSTRAINT FK_FDA8C6E05DE3FDC4 FOREIGN KEY (id_comment_id) REFERENCES comment (id)');
    }
